...
pkg_postinst(){
    ...
    ln -sf "/opt/cross/x86_64-linux-musl/x86_64-linux-musl" "${BUILDENV_DIR}/opt/cross/x86_64-linux-musl/usr"
...
EOF
    ...
    bsdtar -xf "$tmpdir/linux-headers.apk" -C "$BUILDENV_DIR/opt/cross/x86_64-linux-musl"
    rm -rf "$tmpdir"
}
